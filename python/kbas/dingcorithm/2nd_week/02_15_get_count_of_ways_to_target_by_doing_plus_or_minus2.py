...
answer = 0
# + 혹은 -를 통해서 만들 수 있는 모든 경우의 수를 구하는 함수
def get_all_ways_by_doing_plus_or_minus(array, target, current_index, current_sum):
    global answer
    ...
    # + 혹은 - 니깐
    get_all_ways_by_doing_plus_or_minus(array, target, current_index + 1, current_sum + array[current_index])
    get_all_ways_by_doing_plus_or_minus(array, target, current_index + 1, current_sum - array[current_index])

def get_count_of_ways_to_target_by_doing_plus_or_minus(array, target):
    global answer
    get_all_ways_by_doing_plus_or_minus(array, target, 0, 0 )
